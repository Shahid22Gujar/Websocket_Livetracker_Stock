...
SECRET_KEY = 'django-insecure-gzf@vgn)z8lq3%hq@!ey#n*u1^e1#_oum-)!nwx2=av37rj2rz'
...
#Celery Settings for local setup
# CELERY_BROKER_URL = 'redis://localhost:6379'
# CELERY_RESULT_BACKEND = 'redis://localhost:6379'
# CELERY_ACCEPT_CONTENT_TYPE = 'application/json'
# CELERY_RESULT_SERIALIZER = 'json'
# CELERY_TASK_SERIALIZER = 'json'
# CELERY_TIMEZONE='Asia/Kolkata' # by default it sets to UTC
# CELERY_RESULT_BACKEND='django-db'
# CELERY_BEAT_SCHEDULER='django_celery_beat.schedulers:DatabaseScheduler'

#channel-layer for websockt 
#for local setup
# CHANNEL_LAYERS = {
#     'default': {
